...
<head>
    ...
    *{box-sizing:border-box}
    ...
    .btn-detail{color:var(--accent);text-decoration:none;font-weight:600;padding:6px 10px;border-radius:8px;border:1px solid transparent;background:rgba(255,255,255,0.9)}
    .btn-detail:hover{background:#f0fdfa}
    ...
    <div class="container">
        ...
        <tbody>
            ...
            <tr>
                ...
                <!-- 🔹 Tombol Detail -->
                 <td>
                   <a href="detail.php?id=<?= htmlspecialchars($row['id']) ?>" class="btn-detail">🔍 Detail</a><br>
                   <a href="edit.php?id=<?= htmlspecialchars($row['id']) ?>" class="btn-detail">✏️ Edit</a><br>
                   <a href="hapus.php?id=<?= htmlspecialchars($row['id']) ?>" class="btn-detail" style="color:#b91c1c;" onclick="return confirm('Yakin hapus server ini?')">🗑️ Hapus</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </tbody>
